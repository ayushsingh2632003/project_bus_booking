...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: AYUSH SINGH", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B085", font='Arial 16 bold', fg='blue').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<60:
                                                        ...
                                                        showerror("booking limit exceed","entered seats are not in range please refill")
                                                else:
    ...
    def add_bus_op_details_page(self):
        ...
        def op_add():
            ...
            if len(iid) > 0 and len(iid) <= 60 and iid.isnumeric():
